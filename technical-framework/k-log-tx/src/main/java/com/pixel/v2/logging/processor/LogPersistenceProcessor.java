 ...
 * - Log entries as LogEntry objects
 * - Log entries created from Camel exchange headers and body
 */
...
public class LogPersistenceProcessor implements Processor {
    ...
    public void process(Exchange exchange) throws Exception {
        try {
            ...
            LogEntry errorEntry = LogEntry.error("k-log-tx", 
                "Failed to persist log entry: " + e.getMessage());
            ...
            try {
                ...
                System.err.println("Critical: Failed to persist error log entry: " + persistError.getMessage());
            }
    ...
    private void enrichWithExchangeInfo(LogEntry logEntry, Exchange exchange) {
        ...
        if (logEntry.getBreadcrumbId() == null && exchange.getIn().getHeader("breadcrumbId") != null) {
