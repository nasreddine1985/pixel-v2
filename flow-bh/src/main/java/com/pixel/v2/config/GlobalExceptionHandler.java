...
/**
 * Global Exception Handler for BH WPS flows using Camel Event Notifier
 * This bean will catch all exceptions across all Camel routes and trigger error handling
 */
@Configuration
public class GlobalExceptionHandler {
    ...
    public class ExceptionNotifier extends EventNotifierSupport {
        ...
        public void notify(CamelEvent event) throws Exception {
            if (event instanceof ExchangeFailedEvent exchangeFailedEvent) {
                ...
                if (exception != null) {
                    logger.info("[BH-WPS] Global Exception Handler caught: {} - {}",
    ...
    public void registerExceptionHandler() {
        ...
        logger.info("[BH-WPS] Global Exception Handler registered successfully");
    }
}
