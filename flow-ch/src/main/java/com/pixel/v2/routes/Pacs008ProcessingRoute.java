...
public class Pacs008ProcessingRoute extends RouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        from(kameletMqStarterEndpoint).routeId("pacs008-processing-flow")
                .log("K-MQ-Starter kamelet initiated - message will be processed and sent to sink")
                .end();
        ...
        from("direct:process-pacs008-message").routeId("pacs008-message-processing")
                ...
                .setHeader("ProcessingNode", simple("${sys.HOSTNAME}")).log("Message Body: ${body}")
                .log("Message Headers: ${headers}").end();
