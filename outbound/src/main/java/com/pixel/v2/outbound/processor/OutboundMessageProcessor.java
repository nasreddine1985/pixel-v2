package com.pixel.v2.outbound.processor;
...
/**
 * Custom processor for outbound messages
 * 
 * Handles the business logic for processing outbound messages,
 * including message type detection, validation, and enrichment.
 */
@Component("outboundMessageProcessor")
public class OutboundMessageProcessor implements Processor {
    ...
    public void process(Exchange exchange) throws Exception {
        try {
            ...
            logger.info("Processing outbound message: {}", messageBody);
            ...
            logger.error("Error processing outbound message: {}", e.getMessage(), e);
