package com.pixel.v2.distribution.controller;
...
/**
 * REST Controller for testing distribution message processing
 * 
 * Provides endpoints to submit messages directly to the distribution service
...
public class DistributionController {
    ...
    /**
     * Submit a message directly to the distribution service
     */
    @PostMapping("/submit")
    public ResponseEntity<Map<String, Object>> submitMessage(@RequestBody String message) {
        try {
            ...
            producerTemplate.sendBody("direct:distribution-input", message);
    ...
    public ResponseEntity<Map<String, Object>> submitMessageWithHeaders(
        ...
        try {
            ...
            producerTemplate.sendBodyAndHeaders("direct:distribution-input", message, camelHeaders);
